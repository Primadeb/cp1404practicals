...
"""
# Answer 1:  ValueError will occur if the user enters a not a valid integer for numerator or denominator.

# Answer 2:ZeroDivisionError will occur if the user enters zero for the denominator.
